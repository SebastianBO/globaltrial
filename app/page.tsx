      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Connecting patients with life-changing clinical trials worldwide.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/trials" className="hover:text-white">Browse Trials</Link></li>
                <li><Link href="/search" className="hover:text-white">Advanced Search</Link></li>
                <li><Link href="/patient" className="hover:text-white">AI Assistant</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="#" className="hover:text-white">Clinical Trial Guide</a></li>
                <li><a href="#" className="hover:text-white">Patient Rights</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/sponsors" className="hover:text-white">For Sponsors</Link></li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
            <p>&copy; 2024 GlobalTrial. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
