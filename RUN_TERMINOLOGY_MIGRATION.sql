...
-- This adds terminology mapping support to GlobalTrials
...
CREATE INDEX IF NOT EXISTS idx_term_mappings_patient ON medical_term_mappings USING GIN (patient_terms);
CREATE INDEX IF NOT EXISTS idx_term_mappings_medical ON medical_term_mappings USING GIN (medical_terms);
CREATE INDEX IF NOT EXISTS idx_term_mappings_category ON medical_term_mappings(category);
...
-- Test the function
SELECT * FROM find_medical_terms('heart attack');
SELECT * FROM find_medical_terms('high blood pressure');